...
def caffe_wrapper_mtcnn_4faces(targetdir):
    ...
    res=os.popen("echo ./CAFFE_MTCNN targetdir/tests/images/mtcnn_face4.jpg targetdir/models wrapper_result4.jpg;./CAFFE_MTCNN targetdir/tests/images/mtcnn_face4.jpg targetdir/models wrapper_result4.jpg | grep face > /tmp/result.dummy","r")
    out=res.read()
    print(out)
    arr=out.splitlines()
    for char in arr:
